        ...
        <div class="import-content w-clearfix extra">
            ...
            <form id="mec_import_csv_booking_form" action="<?php echo esc_url($this->main->get_full_url()); ?>" method="POST" enctype="multipart/form-data">
                <div class="mec-form-row">
                    ...
                    <p><?php echo sprintf(esc_html__("If you want to create the booking file yourself you can check %s as a sample file.", 'modern-events-calendar-lite'), '<a href="'.esc_url($this->main->asset('files/sample.csv')).'">sample.csv</a>'); ?></p>
