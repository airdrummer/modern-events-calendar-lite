    ...
    <table id="mec_cart_transactions_table">
        ...
        <tbody>
            ...
            <tr id="mec_cart_transactions_<?php echo esc_attr($transaction_id); ?>">
                ...
                <td>
                    <span onclick="jQuery(this).next().toggleClass('mec-util-hidden');" style="cursor: pointer;"><?php echo MEC_kses::element($TO->get_price_html()); ?></span>
                    <div class="mec-util-hidden"><?php echo MEC_kses::element($TO->get_price_details_html()); ?></div>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <div class="mec-cart-coupon-checkout-action">
        ...
        <div class="mec-cart-coupon">
            <form id="mec_cart_coupon_form">
                ...
                <button type="submit"><?php esc_html_e('Apply'); ?></button>
            </form>
