                    ...
                    <form id="mec_styling_form">
                        ...
                        <!-- Colorskin -->
                            ...
                            <div class="mec-form-row">
                                ...
                                <div class="mec-col-9">
                                    <input type="text" id="mec_styling_primary_border_radius" name="mec[styling][primary_border_radius]" value="<?php echo ((isset($styling['container_normal_width']) and trim($styling['container_normal_width']) != '') ? $styling['container_normal_width'] : ''); ?>" />
                            ...
                            <div class="mec-form-row">
                                ...
                                <div class="mec-col-9">
                                    <input type="text" id="mec_styling_secondary_border_radius" name="mec[styling][secondary_border_radius]" value="<?php echo ((isset($styling['container_normal_width']) and trim($styling['container_normal_width']) != '') ? $styling['container_normal_width'] : ''); ?>" />
                                    <span class="mec-tooltip">
                                        <div class="box left">
