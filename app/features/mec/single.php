                                ...
                                <div class="mec-form-row">
                                    ...
                                    <div class="mec-col-9">
                                        <select name="mec[settings][fes_single_event_style]" id="mec_settings_fes_single_event_style">
                                            ...
                                            <?php endif; ?>
                                            <?php if(is_plugin_active( 'mec-gutenberg-single-builder/mec-gutenberg-single-builder.php')): ?>
                                                <option value="gsb-builder" <?php echo (isset($settings['fes_single_event_style']) and $settings['fes_single_event_style'] == 'gsb-builder') ? 'selected="selected"' : ''; ?>><?php esc_html_e('Gutenberg Single Builder', 'modern-events-calendar-lite'); ?></option>
                                            <?php endif; ?>
                                        </select>
                                        <span class="mec-tooltip">
                                            <div class="box left">
