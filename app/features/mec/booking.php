                ...
                <div class="mec-container">
                    ...
                    <form id="mec_booking_form">
                        ...
                        <div id="booking_appointments_options" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php esc_html_e('Appointments', 'modern-events-calendar-lite'); ?></h4>
                            <div class="mec-form-row">
                            ...
                            <div id="mec_appointments_container_toggle" class="<?php if(!isset($settings['appointments_status']) || !$settings['appointments_status']) echo 'mec-util-hidden'; ?>">
                                ...
                                <ul>
                                    ...
                                    <li><?php esc_html_e('Hourly Schedule', 'modern-events-calendar-lite'); ?></li>
                                    <li><?php esc_html_e('SEO Schema / Event Status', 'modern-events-calendar-lite'); ?></li>
                                </ul>
                            </div>
                        </div>
