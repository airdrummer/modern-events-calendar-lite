                                    ...
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <label for="mec_settings_booking_start_from_first_upcoming_date">
                                                ...
                                                <input type="checkbox" name="mec[settings][booking_start_from_first_upcoming_date]" id="mec_settings_booking_start_from_first_upcoming_date" <?php echo ((isset($settings['booking_start_from_first_upcoming_date']) and $settings['booking_start_from_first_upcoming_date'] == '1') ? 'checked="checked"' : ''); ?> value="1" />
