...
// Visual Skin Gallery (UX audit — Issue 3): one-line guidance for each skin.
// Unknown skins (registered via the `mec_calendar_skins` filter) get no description.


$skin_meta = [
    'list' => [
        'desc' => __('Chronological rows with date blocks. A great all-round starting point.', 'modern-events-calendar-lite'),
    ],
    'grid' => [
        'desc' => __('Image-first cards in columns. Best for visual event browsing.', 'modern-events-calendar-lite'),
    ],
    'agenda' => [
        'desc' => __('Events grouped under month headings. Best for dense schedules.', 'modern-events-calendar-lite'),
    ],
    'full_calendar' => [
        'desc' => __('Google-style calendar with month, week and day tabs.', 'modern-events-calendar-lite'),
    ],
    'yearly_view' => [
        'desc' => __('All 12 months at a glance with jump navigation.', 'modern-events-calendar-lite'),
    ],
    'monthly_view' => [
        'desc' => __('Classic month grid; click a day to see its events.', 'modern-events-calendar-lite'),
    ],
    'daily_view' => [
        'desc' => __('A single day and its full program, hour by hour.', 'modern-events-calendar-lite'),
    ],
    'weekly_view' => [
        'desc' => __('Browse the calendar one week at a time.', 'modern-events-calendar-lite'),
    ],
    'timetable' => [
        'desc' => __('Day columns with hourly slots. Best for conferences.', 'modern-events-calendar-lite'),
    ],
    'masonry' => [
        'desc' => __('Pinterest-style image wall. Best for media-rich events.', 'modern-events-calendar-lite'),
    ],
    'map' => [
        'desc' => __('Events pinned on an interactive map by venue.', 'modern-events-calendar-lite'),
    ],
    'cover' => [
        'desc' => __('Full-width hero card for one featured event.', 'modern-events-calendar-lite'),
    ],
    'countdown' => [
        'desc' => __('Live ticking countdown to one big event.', 'modern-events-calendar-lite'),
    ],
    'available_spot' => [
        'desc' => __('Remaining capacity for one bookable event.', 'modern-events-calendar-lite'),
    ],
    'carousel' => [
        'desc' => __('Scrollable row of event cards with arrows.', 'modern-events-calendar-lite'),
    ],
    'slider' => [
        'desc' => __('Full-width slides showing one event at a time.', 'modern-events-calendar-lite'),
    ],
    'timeline' => [
        'desc' => __('Events laid out along a horizontal timeline.', 'modern-events-calendar-lite'),
    ],
    'tile' => [
        'desc' => __('Compact date-block tiles for tight spaces and widgets.', 'modern-events-calendar-lite'),
    ],
    'general_calendar' => [
        'desc' => __('One calendar; visitors switch skins on the front end.', 'modern-events-calendar-lite'),
    ],
];
?>
<div class="mec-calendar-metabox">
    ...
    <div class="mec-meta-box-fields" id="mec_meta_box_calendar_skin_options">
        <div class="mec-form-row mec-field mec-skin-gallery-field">
            <div class="mec-field__label">
                <label for="mec_skin"><?php esc_html_e('Skin', 'modern-events-calendar-lite'); ?></label>
            </div>
            <div class="mec-field__control">
                <div class="mec-skin-gallery" id="mec_skin_gallery">
                    <div class="mec-skin-gallery__grid" role="group" aria-label="<?php esc_attr_e('Choose a skin', 'modern-events-calendar-lite'); ?>">
                        <?php foreach($skins as $skin => $name): ?>
                            <?php
                                $skin_meta_item = isset($skin_meta[$skin]) ? $skin_meta[$skin] : [];
                            ?>
                            <button type="button" class="mec-skin-card" data-skin="<?php echo esc_attr($skin); ?>" aria-pressed="false">
                                <span class="mec-skin-card__body">
                                    <span class="mec-skin-card__name"><?php echo esc_html($name); ?></span>
                                    <?php if(isset($skin_meta_item['desc'])): ?>
                                        <span class="mec-skin-card__desc"><?php echo esc_html($skin_meta_item['desc']); ?></span>
                                    <?php endif; ?>
                                </span>
                            </button>
                        <?php endforeach; ?>
            ...
            <p class="mec-field__help"><?php esc_html_e('Pick the layout this calendar renders with. The options below adapt to your choice.', 'modern-events-calendar-lite'); ?></p>
            </div>
        </div>

        <!-- Classic skin dropdown (fallback for the visual gallery above) -->
        <div class="mec-form-row mec-field mec-util-hidden" id="mec_skin_classic_row">
            <div class="mec-field__label">
                <label for="mec_skin"><?php esc_html_e('Skin', 'modern-events-calendar-lite'); ?></label>
            </div>
            <div class="mec-field__control">
                <select class="wn-mec-select mec-custom-nice-select" name="mec[skin]" id="mec_skin" onchange="if(jQuery('#mec_skin').val() != 'carousel' ){ jQuery('.mec-carousel-archive-link').hide();jQuery('.mec-carousel-head-text').hide();}">
                    <?php foreach($skins as $skin=>$name): ?>
        ...
        <div class="mec-skins-options-container">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_list_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Layout variation of this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][list][start_date_type]" id="mec_skin_list_start_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_list_start_date_container').show(); else jQuery('#mec_skin_list_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_list['start_date_type']) or (isset($sk_options_list['start_date_type']) and $sk_options_list['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_list_start_date_container">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('First date of the period the events come from.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_end_date_type"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][list][end_date_type]" id="mec_skin_list_end_date_type" onchange="if(this.value === 'date') { jQuery('#mec_skin_list_end_date_container, #mec_skin_list_end_date_container_help').show(); } else { jQuery('#mec_skin_list_end_date_container, #mec_skin_list_end_date_container_help').hide(); }">
                        ...
                        <div class="<?php echo (!isset($sk_options_list['end_date_type']) or (isset($sk_options_list['end_date_type']) and $sk_options_list['end_date_type'] == 'date')) ? '' : 'mec-util-hidden'; ?>" id="mec_skin_list_end_date_container">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Last date of the period the events come from.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- End Maximum Date -->
                ...
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'classic') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_classic_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_classic_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][classic_date_format1]" id="mec_skin_list_classic_date_format1" value="<?php echo ((isset($sk_options_list['classic_date_format1']) and trim($sk_options_list['classic_date_format1']) != '') ? $sk_options_list['classic_date_format1'] : 'M d Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. M d Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'M d Y') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_minimal_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_minimal_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][minimal_date_format1]" id="mec_skin_list_minimal_date_format1" value="<?php echo ((isset($sk_options_list['minimal_date_format1']) and trim($sk_options_list['minimal_date_format1']) != '') ? $sk_options_list['minimal_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][list][minimal_date_format2]" id="mec_skin_list_minimal_date_format2" value="<?php echo ((isset($sk_options_list['minimal_date_format2']) and trim($sk_options_list['minimal_date_format2']) != '') ? $sk_options_list['minimal_date_format2'] : 'M'); ?>" />
                        <input type="text" name="mec[sk-options][list][minimal_date_format3]" id="mec_skin_list_minimal_date_format3" value="<?php echo ((isset($sk_options_list['minimal_date_format3']) and trim($sk_options_list['minimal_date_format3']) != '') ? $sk_options_list['minimal_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'modern') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_modern_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_modern_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][modern_date_format1]" id="mec_skin_list_modern_date_format1" value="<?php echo ((isset($sk_options_list['modern_date_format1']) and trim($sk_options_list['modern_date_format1']) != '') ? $sk_options_list['modern_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][list][modern_date_format2]" id="mec_skin_list_modern_date_format2" value="<?php echo ((isset($sk_options_list['modern_date_format2']) and trim($sk_options_list['modern_date_format2']) != '') ? $sk_options_list['modern_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][list][modern_date_format3]" id="mec_skin_list_modern_date_format3" value="<?php echo ((isset($sk_options_list['modern_date_format3']) and trim($sk_options_list['modern_date_format3']) != '') ? $sk_options_list['modern_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'standard') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_standard_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_standard_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][standard_date_format1]" id="mec_skin_list_standard_date_format1" value="<?php echo ((isset($sk_options_list['standard_date_format1']) and trim($sk_options_list['standard_date_format1']) != '') ? $sk_options_list['standard_date_format1'] : 'd M'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. M d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and $sk_options_list['style'] != 'accordion') echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_accordion_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_accordion_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][accordion_date_format1]" id="mec_skin_list_accordion_date_format1" value="<?php echo ((isset($sk_options_list['accordion_date_format1']) and trim($sk_options_list['accordion_date_format1']) != '') ? $sk_options_list['accordion_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][list][accordion_date_format2]" id="mec_skin_list_accordion_date_format2" value="<?php echo ((isset($sk_options_list['accordion_date_format2']) and trim($sk_options_list['accordion_date_format2']) != '') ? $sk_options_list['accordion_date_format2'] : 'F'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and strpos($sk_options_list['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_liquid-large_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_liquid_large_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][liquid_large_date_format1]" id="mec_skin_list_liquid_large_date_format1" value="<?php echo ((isset($sk_options_list['liquid_large_date_format1']) and trim($sk_options_list['liquid_large_date_format1']) != '') ? $sk_options_list['liquid_large_date_format1'] : 'F d'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. F d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and strpos($sk_options_list['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_liquid-medium_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_liquid_medium_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][liquid_medium_date_format1]" id="mec_skin_list_liquid_medium_date_format1" value="<?php echo ((isset($sk_options_list['liquid_medium_date_format1']) and trim($sk_options_list['liquid_medium_date_format1']) != '') ? $sk_options_list['liquid_medium_date_format1'] : 'F d'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. F d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and strpos($sk_options_list['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_liquid-small_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_liquid_small_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][liquid_small_date_format1]" id="mec_skin_list_liquid_small_date_format1" value="<?php echo ((isset($sk_options_list['liquid_small_date_format1']) and trim($sk_options_list['liquid_small_date_format1']) != '') ? $sk_options_list['liquid_small_date_format1'] : 'F d'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. F d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-list-date-format-container <?php if(isset($sk_options_list['style']) and strpos($sk_options_list['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_list_date_format_liquid-minimal_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_liquid_minimal_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][list][liquid_minimal_date_format1]" id="mec_skin_list_liquid_minimal_date_format1" value="<?php echo ((isset($sk_options_list['liquid_minimal_date_format1']) and trim($sk_options_list['liquid_minimal_date_format1']) != '') ? $sk_options_list['liquid_minimal_date_format1'] : 'F d'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. F d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_list_limit"><?php esc_html_e('Limit', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][list][limit]" id="mec_skin_list_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_list['limit'])) echo esc_attr($sk_options_list['limit']); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <?php do_action('mec_skin_options_list_after_limit', $sk_options_list); ?>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-list-liquid" id="mec_skin_list_localtime">
                    <label class="mec-check" for="mec_skin_list_include_local_time">
                        ...
                        <span><?php esc_html_e('Include Local Time', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Show event times converted to each visitor local time zone.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <!-- End LocalTime -->
                <!-- Start Include Events Times -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-times mec-not-list-liquid">
                    <label class="mec-check" for="mec_skin_list_include_events_times">
                        ...
                        <span><?php esc_html_e('Include Events Times', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Show the event start time next to the date.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <!-- End Include Events Times -->
                <?php echo MEC_kses::form($this->display_pagination_field('list', $sk_options_list)); ?>
                <div class="mec-form-row mec-field mec-field--check mec-not-list-fluent mec-not-list-liquid">
                    <label class="mec-check" for="mec_skin_list_month_divider">
                        ...
                        <span><?php esc_html_e('Show Month Divider', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Insert a divider between events of different months.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <?php echo MEC_kses::form($this->display_price_field('list', (isset($sk_options_list['display_price']) ? $sk_options_list['display_price'] : 0))); ?>
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-not-list-liquid" id="mec_skin_list_display_normal_label">
                    <label class="mec-check" for="mec_skin_list_display_label">
                        ...
                        <span><?php esc_html_e('Display Normal Labels', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Show the event labels as small badges on each event.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check mec-not-list-liquid" id="mec_skin_list_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_list_reason_for_cancellation">
                        ...
                        <span><?php esc_html_e('Display Reason for Cancellation', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Show why the event was canceled instead of hiding it.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <!-- End Display Reason for Cancellation -->
                <!-- Start Display Categories -->
                <div class="mec-form-row mec-field mec-field--check mec-not-list-liquid" id="mec_skin_list_display_categories_wp">
                    <label class="mec-check" for="mec_skin_list_display_categories">
                        ...
                        <span><?php esc_html_e('Display Categories', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Show the event categories as small badges on each event.', 'modern-events-calendar-lite'); ?></p>
                </div>
                ...
                <div class="mec-form-row mec-field mec-not-list-liquid">
                    <div class="mec-field__label">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Add a map above the results with a pin per event location.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <?php else: ?>
                <div class="mec-form-row mec-field mec-field--check mec-not-list-liquid">
                    <label class="mec-check" for="mec_skin_list_map_on_top">
                        ...
                        <span><?php esc_html_e('Show Map on top', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Add a map above the list with a pin per event location.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <?php endif; ?>
                <!-- Start Set Map Geolocation -->
                <div class="mec-form-row mec-field mec-field--check mec-set-geolocation <?php if(!isset($sk_options_list['map_on_top']) or (isset($sk_options_list['map_on_top']) and !$sk_options_list['map_on_top'])) echo 'mec-util-hidden'; ?>">
                    <label class="mec-check" for="mec_skin_list_set_geo_location">
                        <input type="hidden" name="mec[sk-options][list][set_geolocation]" value="0" />
                        <input type="checkbox" name="mec[sk-options][list][set_geolocation]" id="mec_skin_list_set_geo_location" value="1" onchange="mec_skin_geolocation_toggle(this);" <?php if(isset($sk_options_list['set_geolocation']) and trim($sk_options_list['set_geolocation'])) echo 'checked="checked"'; ?> />
                        <span><?php esc_html_e('Geolocation', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Ask visitors for their position and sort events by distance', 'modern-events-calendar-lite'); ?></p>
                </div>
                <div class="mec-form-row mec-field mec-field--check mec-set-geolocation-focus <?php if((!isset($sk_options_list['set_geolocation']) or (isset($sk_options_list['set_geolocation']) and !$sk_options_list['set_geolocation'])) or (!isset($sk_options_list['map_on_top']) or (isset($sk_options_list['map_on_top']) and !$sk_options_list['map_on_top']))) echo 'mec-util-hidden'; ?>">
                    <label class="mec-check" for="mec_skin_list_set_geo_location_focus">
                        <input type="hidden" name="mec[sk-options][list][set_geolocation_focus]" value="0" />
                        <input type="checkbox" name="mec[sk-options][list][set_geolocation_focus]" id="mec_skin_list_set_geo_location_focus" value="1" <?php if(isset($sk_options_list['set_geolocation_focus']) and trim($sk_options_list['set_geolocation_focus'])) echo 'checked="checked"'; ?> />
                        <span><?php esc_html_e('Disable Geolocation Force Focus', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Keep the map from jumping to the visitor position on load.', 'modern-events-calendar-lite'); ?></p>
                </div>
                ...
                <div class="mec-form-row mec-field mec-field--check mec-toggle-month-divider mec-not-list-fluent mec-not-list-liquid">
                    <label class="mec-check" for="mec_skin_list_toggle_month_divider">
                        ...
                        <span><?php esc_html_e('Toggle for Month Divider', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Collapse events of each month behind a clickable month heading.', 'modern-events-calendar-lite'); ?></p>
                </div>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_grid_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][grid][style]" id="mec_skin_grid_style" onchange="mec_skin_style_changed('grid', this.value);">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][grid][start_date_type]" id="mec_skin_grid_start_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_grid_start_date_container').show(); else jQuery('#mec_skin_grid_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_grid['start_date_type']) or (isset($sk_options_grid['start_date_type']) and $sk_options_grid['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_end_date_type"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][grid][end_date_type]" id="mec_skin_grid_end_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_grid_end_date_container').show(); else jQuery('#mec_skin_grid_end_date_container').hide();">
                        ...
                        <div class="<?php echo (!isset($sk_options_grid['end_date_type']) or (isset($sk_options_grid['end_date_type']) and $sk_options_grid['end_date_type'] == 'date')) ? '' : 'mec-util-hidden'; ?>" id="mec_skin_grid_end_date_container">
                ...
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'classic') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_classic_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_classic_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][classic_date_format1]" id="mec_skin_grid_classic_date_format1" value="<?php echo ((isset($sk_options_grid['classic_date_format1']) and trim($sk_options_grid['classic_date_format1']) != '') ? $sk_options_grid['classic_date_format1'] : 'd F Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. d F Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_clean_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_clean_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][clean_date_format1]" id="mec_skin_grid_clean_date_format1" value="<?php echo ((isset($sk_options_grid['clean_date_format1']) and trim($sk_options_grid['clean_date_format1']) != '') ? $sk_options_grid['clean_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][grid][clean_date_format2]" id="mec_skin_grid_clean_date_format2" value="<?php echo ((isset($sk_options_grid['clean_date_format2']) and trim($sk_options_grid['clean_date_format2']) != '') ? $sk_options_grid['clean_date_format2'] : 'F'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'minimal') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_minimal_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_minimal_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][minimal_date_format1]" id="mec_skin_grid_minimal_date_format1" value="<?php echo ((isset($sk_options_grid['minimal_date_format1']) and trim($sk_options_grid['minimal_date_format1']) != '') ? $sk_options_grid['minimal_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][grid][minimal_date_format2]" id="mec_skin_grid_minimal_date_format2" value="<?php echo ((isset($sk_options_grid['minimal_date_format2']) and trim($sk_options_grid['minimal_date_format2']) != '') ? $sk_options_grid['minimal_date_format2'] : 'M'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'modern') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_modern_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_modern_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][modern_date_format1]" id="mec_skin_grid_modern_date_format1" value="<?php echo ((isset($sk_options_grid['modern_date_format1']) and trim($sk_options_grid['modern_date_format1']) != '') ? $sk_options_grid['modern_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][grid][modern_date_format2]" id="mec_skin_grid_modern_date_format2" value="<?php echo ((isset($sk_options_grid['modern_date_format2']) and trim($sk_options_grid['modern_date_format2']) != '') ? $sk_options_grid['modern_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][grid][modern_date_format3]" id="mec_skin_grid_modern_date_format3" value="<?php echo ((isset($sk_options_grid['modern_date_format3']) and trim($sk_options_grid['modern_date_format3']) != '') ? $sk_options_grid['modern_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'simple') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_simple_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_simple_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][simple_date_format1]" id="mec_skin_grid_simple_date_format1" value="<?php echo ((isset($sk_options_grid['simple_date_format1']) and trim($sk_options_grid['simple_date_format1']) != '') ? $sk_options_grid['simple_date_format1'] : 'M d Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. M d Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'colorful') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_colorful_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_colorful_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][colorful_date_format1]" id="mec_skin_grid_colorful_date_format1" value="<?php echo ((isset($sk_options_grid['colorful_date_format1']) and trim($sk_options_grid['colorful_date_format1']) != '') ? $sk_options_grid['colorful_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][grid][colorful_date_format2]" id="mec_skin_grid_colorful_date_format2" value="<?php echo ((isset($sk_options_grid['colorful_date_format2']) and trim($sk_options_grid['colorful_date_format2']) != '') ? $sk_options_grid['colorful_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][grid][colorful_date_format3]" id="mec_skin_grid_colorful_date_format3" value="<?php echo ((isset($sk_options_grid['colorful_date_format3']) and trim($sk_options_grid['colorful_date_format3']) != '') ? $sk_options_grid['colorful_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'novel') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_novel_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_novel_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][novel_date_format1]" id="mec_skin_grid_novel_date_format1" value="<?php echo ((isset($sk_options_grid['novel_date_format1']) and trim($sk_options_grid['novel_date_format1']) != '') ? $sk_options_grid['novel_date_format1'] : 'd F Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. d F Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and strpos($sk_options_grid['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_liquid-large_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_liquid_large_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][liquid_large_date_format1]" id="mec_skin_grid_liquid_large_date_format1" value="<?php echo ((isset($sk_options_grid['liquid_large_date_format1']) and trim($sk_options_grid['liquid_large_date_format1']) != '') ? $sk_options_grid['liquid_large_date_format1'] : 'F d'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. F d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and strpos($sk_options_grid['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_liquid-medium_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_liquid_medium_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][liquid_medium_date_format1]" id="mec_skin_grid_liquid_medium_date_format1" value="<?php echo ((isset($sk_options_grid['liquid_medium_date_format1']) and trim($sk_options_grid['liquid_medium_date_format1']) != '') ? $sk_options_grid['liquid_medium_date_format1'] : 'F d'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. F d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and strpos($sk_options_grid['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_liquid-small_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_liquid_small_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][liquid_small_date_format1]" id="mec_skin_grid_liquid_small_date_format1" value="<?php echo ((isset($sk_options_grid['liquid_small_date_format1']) and trim($sk_options_grid['liquid_small_date_format1']) != '') ? $sk_options_grid['liquid_small_date_format1'] : 'F d'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. F d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and strpos($sk_options_grid['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_liquid-minimal_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_liquid_minimal_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][grid][liquid_minimal_date_format1]" id="mec_skin_grid_liquid_minimal_date_format1" value="<?php echo ((isset($sk_options_grid['liquid_minimal_date_format1']) and trim($sk_options_grid['liquid_minimal_date_format1']) != '') ? $sk_options_grid['liquid_minimal_date_format1'] : 'F d'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. F d. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_count"><?php esc_html_e('Count in row', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][grid][count]" id="mec_skin_grid_count">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Number of event cards per row on desktop screens.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <?php do_action('mec_skin_options_grid_after_count', $sk_options_grid); ?>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_grid_limit"><?php esc_html_e('Limit', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][grid][limit]" id="mec_skin_grid_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_grid['limit'])) echo esc_attr($sk_options_grid['limit']); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <?php do_action('mec_skin_options_grid_after_limit', $sk_options_grid); ?>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_grid_localtime">
                    <label class="mec-check" for="mec_skin_grid_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Include Events Times -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-times mec-not-grid-liquid">
                    <label class="mec-check" for="mec_skin_grid_include_events_times">
                ...
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-grid-liquid" id="mec_skin_grid_display_normal_label">
                    <label class="mec-check" for="mec_skin_grid_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check mec-not-grid-liquid" id="mec_skin_grid_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_grid_reason_for_cancellation">
                ...
                <!-- End Display Reason for Cancellation -->
                <!-- Start Display Categories -->
                <div class="mec-form-row mec-field mec-field--check mec-not-grid-liquid" id="mec_skin_grid_display_categories_wp">
                    <label class="mec-check" for="mec_skin_grid_display_categories">
                ...
                <!-- End Display Organizer -->
                <?php if(!$this->main->getPRO()): ?>
                <div class="mec-form-row mec-field mec-not-grid-liquid">
                    <div class="mec-field__label">
                ...
                <?php else: ?>
                <div class="mec-form-row mec-field mec-field--check mec-not-grid-liquid">
                    <label class="mec-check" for="mec_skin_grid_map_on_top">
                ...
                <?php endif; ?>
                <!-- Start Set Map Geolocation -->
                <div class="mec-form-row mec-field mec-field--check mec-set-geolocation <?php if(!isset($sk_options_grid['map_on_top']) or (isset($sk_options_grid['map_on_top']) and !$sk_options_grid['map_on_top'])) echo 'mec-util-hidden'; ?>">
                    <label class="mec-check" for="mec_skin_grid_set_geo_location">
                        <input type="hidden" name="mec[sk-options][grid][set_geolocation]" value="0" />
                        <input type="checkbox" name="mec[sk-options][grid][set_geolocation]" id="mec_skin_grid_set_geo_location" value="1" onchange="mec_skin_geolocation_toggle(this);" <?php if(isset($sk_options_grid['set_geolocation']) and trim($sk_options_grid['set_geolocation'])) echo 'checked="checked"'; ?> />
                        <span><?php esc_html_e('Geolocation', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Ask visitors for their position and sort events by distance', 'modern-events-calendar-lite'); ?></p>
                </div>
                <div class="mec-form-row mec-field mec-field--check mec-set-geolocation-focus <?php if((!isset($sk_options_grid['set_geolocation']) or (isset($sk_options_grid['set_geolocation']) and !$sk_options_grid['set_geolocation'])) or (!isset($sk_options_grid['map_on_top']) or (isset($sk_options_grid['map_on_top']) and !$sk_options_grid['map_on_top']))) echo 'mec-util-hidden'; ?>">
                    <label class="mec-check" for="mec_skin_grid_set_geo_location_focus">
                        <input type="hidden" name="mec[sk-options][grid][set_geolocation_focus]" value="0" />
                        <input type="checkbox" name="mec[sk-options][grid][set_geolocation_focus]" id="mec_skin_grid_set_geo_location_focus" value="1" <?php if(isset($sk_options_grid['set_geolocation_focus']) and trim($sk_options_grid['set_geolocation_focus'])) echo 'checked="checked"'; ?> />
                        <span><?php esc_html_e('Disable Geolocation Force Focus', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Keep the map from jumping to the visitor position on load.', 'modern-events-calendar-lite'); ?></p>
                </div>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_agenda_skin_options_container">
                ...
                <?php if(!$this->main->getPRO()): ?>
                    <div class="info-msg"><?php echo sprintf(esc_html__("%s is required to use this skin.", 'modern-events-calendar-lite'), $this->main->pro_notice_link()); ?></div>
                <?php endif; ?>

                <?php $sk_options_agenda = isset($sk_options['agenda']) ? $sk_options['agenda'] : []; ?>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_agenda_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][agenda][style]" id="mec_skin_agenda_style" onchange="mec_skin_style_changed('agenda', this.value);">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_agenda_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][agenda][start_date_type]" id="mec_skin_agenda_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_agenda_start_date_container').show(); else jQuery('#mec_skin_agenda_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_agenda['start_date_type']) or (isset($sk_options_agenda['start_date_type']) and $sk_options_agenda['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_agenda_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_agenda_end_date_type"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][agenda][end_date_type]" id="mec_skin_agenda_end_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_agenda_end_date_container').show(); else jQuery('#mec_skin_agenda_end_date_container').hide();">
                        ...
                        <div class="<?php echo (!isset($sk_options_agenda['end_date_type']) or (isset($sk_options_agenda['end_date_type']) and $sk_options_agenda['end_date_type'] == 'date')) ? '' : 'mec-util-hidden'; ?>" id="mec_skin_agenda_end_date_container">
                ...
                <div class="mec-form-row mec-field mec-skin-agenda-date-format-container <?php if(isset($sk_options_agenda['style']) and $sk_options_agenda['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_agenda_date_format_clean_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_agenda_clean_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][agenda][clean_date_format1]" id="mec_skin_agenda_clean_date_format1" value="<?php echo ((isset($sk_options_agenda['clean_date_format1']) and trim($sk_options_agenda['clean_date_format1']) != '') ? $sk_options_agenda['clean_date_format1'] : 'l'); ?>" />
                        <input type="text" name="mec[sk-options][agenda][clean_date_format2]" id="mec_skin_agenda_clean_date_format2" value="<?php echo ((isset($sk_options_agenda['clean_date_format2']) and trim($sk_options_agenda['clean_date_format2']) != '') ? $sk_options_agenda['clean_date_format2'] : 'F j'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_agenda_limit"><?php esc_html_e('Limit', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][agenda][limit]" id="mec_skin_agenda_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_agenda['limit'])) echo esc_attr($sk_options_agenda['limit']); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <?php do_action('mec_skin_options_agenda_after_limit', $sk_options_agenda); ?>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times">
                    <label class="mec-check" for="mec_skin_agenda_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_agenda_display_normal_label">
                    <label class="mec-check" for="mec_skin_agenda_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_agenda_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_agenda_reason_for_cancellation">
                ...
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_agenda_month_divider">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_full_calendar_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_full_calendar_style"><?php _e('Style', 'mec-liq'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][full_calendar][style]" id="mec_skin_full_calendar_style" onchange="mec_skin_style_changed('full_calendar', this.value);">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_full_calendar_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][full_calendar][start_date_type]" id="mec_skin_full_calendar_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_full_calendar_start_date_container').show(); else jQuery('#mec_skin_full_calendar_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_full_calendar['start_date_type']) or (isset($sk_options_full_calendar['start_date_type']) and $sk_options_full_calendar['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_full_calendar_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_full_calendar_default_view"><?php esc_html_e('Default View', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][full_calendar][default_view]" id="mec_skin_full_calendar_default_view">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('The tab visitors see first when the calendar loads.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-not-full_calendar-fluent mec-not-full_calendar-liquid <?php echo (!isset($sk_options_full_calendar['monthly']) or (isset($sk_options_full_calendar['monthly']) and $sk_options_full_calendar['monthly'])) ? '' : 'mec-util-hidden'; ?>" id="mec_full_calendar_monthly_style">
                    <div class="mec-field__label">
                        <label for="mec_skin_full_calendar_monthly_style"><?php esc_html_e('Monthly Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][full_calendar][monthly_style]" id="mec_skin_full_calendar_monthly_style">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Layout used for the monthly view of this calendar.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-not-full_calendar-liquid">
                    <div class="mec-field__label">
                        <label for="mec_skin_full_calendar_limit"><?php esc_html_e('Events per day', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][full_calendar][limit]" id="mec_skin_full_calendar_limit" placeholder="eg. 6" value="<?php if(isset($sk_options_full_calendar['limit'])) echo esc_attr($sk_options_full_calendar['limit']); ?>">
                    <p class="mec-field__help"><?php esc_html_e('Maximum number of events shown for a single day.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                ...
                <div class="mec-skin-full-calendar-list-wrap">
                    <div class="mec-form-row mec-field mec-field--check">
                        <label class="mec-check" for="mec_skin_full_calendar_list">
                            ...
                            <span><?php esc_html_e('List View', 'modern-events-calendar-lite'); ?></span>
                        </label>
                        <p class="mec-field__help"><?php esc_html_e('Offer this view as a tab visitors can switch to.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                    <?php
                    ...
                    ?>
                    <div class="mec-date-format <?php echo (!isset($sk_options_full_calendar['list']) or (isset($sk_options_full_calendar['list']) and $sk_options_full_calendar['list'])) ? '' : 'mec-util-hidden'; ?>">
                        <div class="mec-form-row mec-field">
                            <div class="mec-field__label">
                                <label for="mec_skin_full_calendar_date_format_list"><?php esc_html_e('List View Date Formats', 'modern-events-calendar-lite'); ?></label>
                            </div>
                            <div class="mec-field__control">
                                <input type="text" name="mec[sk-options][full_calendar][date_format_list]" id="mec_skin_full_calendar_date_format_list" value="<?php echo esc_attr($date_format_list); ?>"/>
                            <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                            </div>
                        </div>
                        <div class="mec-form-row mec-field">
                            <div class="mec-field__label">
                                <label for="mec_skin_full_calendar_end_date_type_list"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?></label>
                            </div>
                            <div class="mec-field__control">
                                <select class="wn-mec-select" name="mec[sk-options][full_calendar][end_date_type_list]" id="mec_skin_full_calendar_end_date_type_list" onchange="if(this.value === 'date') jQuery('#mec_skin_full_calendar_end_date_list_container').show(); else jQuery('#mec_skin_full_calendar_end_date_list_container').hide();">
                                ...
                                <div class="<?php echo (!isset($sk_options_full_calendar['end_date_type_list']) or (isset($sk_options_full_calendar['end_date_type_list']) and $sk_options_full_calendar['end_date_type_list'] == 'date')) ? '' : 'mec-util-hidden'; ?>" id="mec_skin_full_calendar_end_date_list_container">
                ...
                <div class="mec-skin-full-calendar-grid-wrap">
                    <div class="mec-form-row mec-field mec-field--check">
                        <label class="mec-check" for="mec_skin_full_calendar_grid">
                            ...
                            <span><?php esc_html_e('Grid View', 'modern-events-calendar-lite'); ?></span>
                        </label>
                        <p class="mec-field__help"><?php esc_html_e('Offer this view as a tab visitors can switch to.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                    <div class="mec-date-format <?php echo (!isset($sk_options_full_calendar['grid']) or (isset($sk_options_full_calendar['grid']) and $sk_options_full_calendar['grid'])) ? '' : 'mec-util-hidden'; ?>">
                        <div class="mec-form-row mec-field">
                            <div class="mec-field__label">
                                <label for="mec_skin_full_calendar_end_date_type_grid"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?></label>
                            </div>
                            <div class="mec-field__control">
                                <select class="wn-mec-select" name="mec[sk-options][full_calendar][end_date_type_grid]" id="mec_skin_full_calendar_end_date_type_grid" onchange="if(this.value === 'date') jQuery('#mec_skin_full_calendar_end_date_grid_container').show(); else jQuery('#mec_skin_full_calendar_end_date_grid_container').hide();">
                                ...
                                <div class="<?php echo (!isset($sk_options_full_calendar['end_date_type_grid']) or (isset($sk_options_full_calendar['end_date_type_grid']) and $sk_options_full_calendar['end_date_type_grid'] == 'date')) ? '' : 'mec-util-hidden'; ?>" id="mec_skin_full_calendar_end_date_grid_container">
                ...
                <div class="mec-form-row mec-field mec-field--check mec-not-full_calendar-liquid">
                    <label class="mec-check" for="mec_skin_full_calendar_tile">
                        ...
                        <span><?php esc_html_e('Tile View', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Offer this view as a tab visitors can switch to.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <div class="mec-skin-full-calendar-yearly-wrap mec-not-full_calendar-liquid">
                    <div class="mec-form-row mec-field mec-field--check">
                        <label class="mec-check" for="mec_skin_full_calendar_yearly">
                            <input type="hidden" name="mec[sk-options][full_calendar][yearly]" value="0" />
                            <?php if($this->main->getPRO()) { echo '<input type="checkbox" name="mec[sk-options][full_calendar][yearly]" id="mec_skin_full_calendar_yearly" onchange="mec_skin_full_calendar_skin_toggled(this);" value="1" '; if(isset($sk_options_full_calendar['yearly']) and $sk_options_full_calendar['yearly']) echo 'checked="checked" '; echo '/>'; } else { echo '<input type="checkbox" name="mec[sk-options][full_calendar][yearly]" id="mec_skin_full_calendar_yearly" value="0" />'; } ?>
                            <span><?php esc_html_e('Yearly View', 'modern-events-calendar-lite'); ?></span>
                        </label>
                        <p class="mec-field__help"><?php esc_html_e('Offer this view as a tab visitors can switch to.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                    <?php
                    ...
                    ?>
                    <div class="mec-date-format <?php echo (isset($sk_options_full_calendar['yearly']) and $sk_options_full_calendar['yearly']) ? '' : 'mec-util-hidden'; ?>">
                        <div class="mec-form-row mec-field mec-not-full_calendar-fluent">
                            <div class="mec-field__label">
                                <label for="mec_skin_full_calendar_date_format_yearly_1"><?php esc_html_e('Yearly View Date Formats', 'modern-events-calendar-lite'); ?></label>
                            </div>
                            <div class="mec-field__control">
                                <input type="text" name="mec[sk-options][full_calendar][date_format_yearly_1]" id="mec_skin_full_calendar_date_format_yearly_1" value="<?php echo esc_attr($date_format_yearly_1); ?>"/>
                                <input type="text" name="mec[sk-options][full_calendar][date_format_yearly_2]" id="mec_skin_full_calendar_date_format_yearly_2" value="<?php echo esc_attr($date_format_yearly_2); ?>"/>
                            <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mec-form-row mec-not-full_calendar-liquid">
                    <?php if(!$this->main->getPRO()): ?>
                        <div class="info-msg"><?php echo sprintf(esc_html__("%s is required to use %s skin.", 'modern-events-calendar-lite'), $this->main->pro_notice_link(), '<b>'.esc_html__('Yearly View', 'modern-events-calendar-lite').'</b>'); ?></div>
                    <?php endif; ?>
                </div>
                <div class="mec-form-row mec-field mec-field--check mec-not-full_calendar-liquid">
                    <label class="mec-check" for="mec_skin_full_calendar_monthly">
                        ...
                        <span><?php esc_html_e('Monthly/Calendar View', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Offer this view as a tab visitors can switch to.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <div id="mec_full_calendar_monthly_view_options" <?php echo (isset($sk_options_full_calendar['monthly']) and $sk_options_full_calendar['monthly']) ? '' : 'style="display:none;"'; ?>>
                    <div class="mec-form-row mec-field mec-field--check mec-not-full_calendar-liquid">
                        <label class="mec-check" for="mec_skin_full_calendar_activate_first_date">
                            ...
                            <span><?php esc_html_e('Activate First upcoming Date with Event', 'modern-events-calendar-lite'); ?></span>
                        </label>
                        <p class="mec-field__help"><?php esc_html_e('Open the calendar on the first day that has an event.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                    <div class="mec-form-row mec-field mec-field--check mec-not-full_calendar-liquid">
                        <label class="mec-check" for="mec_skin_full_calendar_activate_current_day">
                            ...
                            <span><?php esc_html_e('Activate Current Day in Next / Previous Months', 'modern-events-calendar-lite'); ?></span>
                        </label>
                        <p class="mec-field__help"><?php esc_html_e('Highlight today when browsing other months.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                    <div class="mec-form-row mec-field mec-field--check mec-not-full_calendar-liquid">
                        <label class="mec-check" for="mec_skin_full_calendar_display_all">
                            ...
                            <span><?php esc_html_e('Display all events in right section', 'modern-events-calendar-lite'); ?></span>
                        </label>
                        <p class="mec-field__help"><?php esc_html_e('List every event of the month in the side panel instead of the selected day only.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                    <div class="mec-form-row mec-field mec-field--check" id="mec_skin_full_calendar_mobile_clean_style_wrapper">
                        <label class="mec-check" for="mec_skin_full_calendar_mobile_clean_style">
                            ...
                            <span><?php esc_html_e('Clean Style in Mobile', 'modern-events-calendar-lite'); ?></span>
                        </label>
                        <p class="mec-field__help"><?php esc_html_e('Use a simplified layout on mobile screens.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_full_calendar_weekly">
                        ...
                        <span><?php esc_html_e('Weekly View', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Offer this view as a tab visitors can switch to.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_full_calendar_daily">
                        ...
                        <span><?php esc_html_e('Daily View', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Offer this view as a tab visitors can switch to.', 'modern-events-calendar-lite'); ?></p>
                </div>
                ...
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-full_calendar-liquid" id="mec_skin_full_calendar_display_normal_label">
                    <label class="mec-check" for="mec_skin_full_calendar_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check mec-not-full_calendar-liquid" id="mec_skin_full_calendar_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_full_calendar_reason_for_cancellation">
                ...
                <!-- End Display Reason for Cancellation -->
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-full_calendar-liquid" id="mec_skin_full_calendar_localtime">
                    <label class="mec-check" for="mec_skin_full_calendar_include_local_time">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_yearly_view_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_yearly_view_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][yearly_view][style]" id="mec_skin_yearly_view_style" onchange="mec_skin_style_changed('yearly_view', this.value);">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_yearly_view_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][yearly_view][start_date_type]" id="mec_skin_yearly_view_start_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_yearly_view_start_date_container').show(); else jQuery('#mec_skin_yearly_view_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_yearly_view['start_date_type']) or (isset($sk_options_yearly_view['start_date_type']) and $sk_options_yearly_view['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_yearly_view_start_date_container">
                ...
                <div class="mec-form-row mec-field mec-skin-yearly-view-date-format-container mec-not-yearly_view-fluent mec-not-yearly_view-liquid <?php if(isset($sk_options_yearly_view['style']) and $sk_options_yearly_view['style'] != 'modern') echo 'mec-util-hidden'; ?>" id="mec_skin_yearly_view_date_format_modern_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_agenda_modern_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][yearly_view][modern_date_format1]" id="mec_skin_yearly_view_modern_date_format1" value="<?php echo ((isset($sk_options_yearly_view['modern_date_format1']) and trim($sk_options_yearly_view['modern_date_format1']) != '') ? $sk_options_yearly_view['modern_date_format1'] : 'l'); ?>" />
                        <input type="text" name="mec[sk-options][yearly_view][modern_date_format2]" id="mec_skin_yearly_view_modern_date_format2" value="<?php echo ((isset($sk_options_yearly_view['modern_date_format2']) and trim($sk_options_yearly_view['modern_date_format2']) != '') ? $sk_options_yearly_view['modern_date_format2'] : 'F j'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-yearly-view-date-format-container mec-yearly_view-fluent <?php if(isset($sk_options_yearly_view['style']) and $sk_options_yearly_view['style'] != 'fluent') echo 'mec-util-hidden'; ?>" id="mec_skin_yearly_view_date_format_fluent_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_yearly_view_fluent_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][yearly_view][fluent_date_format1]" id="mec_skin_yearly_view_fluent_date_format1" value="<?php echo ((isset($sk_options_yearly_view['fluent_date_format1']) and trim($sk_options_yearly_view['fluent_date_format1']) != '') ? $sk_options_yearly_view['fluent_date_format1'] : 'l'); ?>" />
                        <input type="text" name="mec[sk-options][yearly_view][fluent_date_format2]" id="mec_skin_yearly_view_fluent_date_format2" value="<?php echo ((isset($sk_options_yearly_view['fluent_date_format2']) and trim($sk_options_yearly_view['fluent_date_format2']) != '') ? $sk_options_yearly_view['fluent_date_format2'] : 'F j'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-not-yearly_view-fluent mec-not-yearly_view-liquid">
                    <div class="mec-field__label">
                        <label for="mec_skin_yearly_view_limit"><?php esc_html_e('Events per day', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][yearly_view][limit]" id="mec_skin_yearly_view_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_yearly_view['limit'])) echo esc_attr($sk_options_yearly_view['limit']); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Maximum number of events shown for a single day.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_yearly_view_months_1"><?php esc_html_e('Months to Display', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <div id="mec-all-month">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Number of months shown at once, e.g. 12 for a full year.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times">
                    <label class="mec-check" for="mec_skin_yearly_view_include_local_time">
                ...
                <!-- End LocalTime -->
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_yearly_view_next_previous_button">
                        ...
                        <span><?php esc_html_e('Next/Previous Buttons', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Show arrows to navigate between periods.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_yearly_view_display_normal_label">
                    <label class="mec-check" for="mec_skin_yearly_view_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_yearly_view_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_yearly_view_reason_for_cancellation">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_monthly_view_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_monthly_view_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][monthly_view][style]" id="mec_skin_monthly_view_style" onchange="mec_skin_style_changed('monthly_view', this.value);">
                ...
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_monthly_view_mobile_clean_style_wrapper">
                    <label class="mec-check" for="mec_skin_monthly_view_mobile_clean_style">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_monthly_view_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][monthly_view][start_date_type]" id="mec_skin_monthly_view_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_monthly_view_start_date_container').show(); else jQuery('#mec_skin_monthly_view_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_monthly_view['start_date_type']) or (isset($sk_options_monthly_view['start_date_type']) and $sk_options_monthly_view['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_monthly_view_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_monthly_view_limit"><?php esc_html_e('Events per day', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][monthly_view][limit]" id="mec_skin_monthly_view_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_monthly_view['limit'])) echo esc_attr($sk_options_monthly_view['limit']); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Maximum number of events shown for a single day.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-monthly_view-fluent mec-not-monthly_view-liquid">
                    <label class="mec-check" for="mec_skin_monthly_view_include_local_time">
                ...
                <!-- End LocalTime -->
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_monthly_view_next_previous_button">
                ...
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-monthly_view-fluent mec-not-monthly_view-liquid" id="mec_skin_monthly_view_display_normal_label">
                    <label class="mec-check" for="mec_skin_monthly_view_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check mec-not-monthly_view-fluent mec-not-monthly_view-liquid" id="mec_skin_monthly_view_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_monthly_view_reason_for_cancellation">
                ...
                <!-- End Display Organizer -->
                <div class="mec-form-row mec-field mec-field--check mec-not-monthly_view-fluent mec-not-monthly_view-liquid">
                    <label class="mec-check" for="mec_skin_monthly_view_activate_first_date">
                ...
                <div class="mec-form-row mec-field mec-field--check mec-not-monthly_view-fluent mec-not-monthly_view-liquid">
                    <label class="mec-check" for="mec_skin_monthly_view_activate_current_day">
                ...
                <div class="mec-form-row mec-field mec-field--check mec-not-monthly_view-fluent mec-not-monthly_view-liquid mec-display-events-right-section">
                    <label class="mec-check" for="mec_skin_monthly_view_display_all">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_map_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_map_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][map][style]" id="mec_skin_map_style" onchange="mec_skin_style_changed('map', this.value);">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_map_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][map][start_date_type]" id="mec_skin_map_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_map_start_date_container').show(); else jQuery('#mec_skin_map_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_map['start_date_type']) or (isset($sk_options_map['start_date_type']) and $sk_options_map['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_map_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_map_limit"><?php esc_html_e('Maximum events', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][map][limit]" id="mec_skin_map_limit" placeholder="<?php esc_html_e('eg. 200', 'modern-events-calendar-lite'); ?>" value="<?php echo (isset($sk_options_map['limit']) ? esc_attr($sk_options_map['limit']) : 200); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_map_geolocation">
                ...
                <div class="mec-form-row mec-field mec-field--check mec-set-geolocation-focus <?php if(!isset($sk_options_map['geolocation']) or (isset($sk_options_map['geolocation']) and !$sk_options_map['geolocation'])) echo 'mec-util-hidden'; ?>">
                    <label class="mec-check" for="mec_skin_map_geolocation_focus">
                ...
                <p class="mec-field__help"><?php esc_html_e('The geolocation feature works only in secure (https) websites.', 'modern-events-calendar-lite'); ?></p>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_daily_view_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_daily_view_style"><?php _e('Style', 'mec-liq'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][daily_view][style]"
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_daily_view_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][daily_view][start_date_type]" id="mec_skin_daily_view_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_daily_view_start_date_container').show(); else jQuery('#mec_skin_daily_view_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_daily_view['start_date_type']) or (isset($sk_options_daily_view['start_date_type']) and $sk_options_daily_view['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_daily_view_start_date_container">
                ...
                <div class="mec-form-row mec-field mec-not-daily_view-liquid">
                    <div class="mec-field__label">
                        <label for="mec_skin_daily_view_limit"><?php esc_html_e('Events per day', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][daily_view][limit]" id="mec_skin_daily_view_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_daily_view['limit'])) echo esc_attr($sk_options_daily_view['limit']); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Maximum number of events shown for a single day.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <?php do_action('mec_skin_options_daily_view_after_limit', $sk_options_daily_view); ?>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-daily_view-liquid">
                    <label class="mec-check" for="mec_skin_daily_view_include_local_time">
                ...
                <!-- End LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-not-daily_view-liquid">
                    <label class="mec-check" for="mec_skin_daily_view_next_previous_button">
                ...
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-daily_view-liquid" id="mec_skin_daily_view_display_normal_label">
                    <label class="mec-check" for="mec_skin_daily_view_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check mec-not-daily_view-liquid" id="mec_skin_daily_view_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_daily_view_reason_for_cancellation">
                ...
                <!-- End Display Reason for Cancellation -->
                <!-- Start Display Categories -->
                <div class="mec-form-row mec-field mec-field--check mec-not-daily_view-liquid" id="mec_skin_daily_view_display_categories_wp">
                    <label class="mec-check" for="mec_skin_daily_view_display_categories">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_weekly_view_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_weekly_view_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][weekly_view][style]" id="mec_skin_weekly_view_style" onchange="mec_skin_style_changed('weekly_view', this.value);">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_weekly_view_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][weekly_view][start_date_type]" id="mec_skin_weekly_view_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_weekly_view_start_date_container').show(); else jQuery('#mec_skin_weekly_view_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_weekly_view['start_date_type']) or (isset($sk_options_weekly_view['start_date_type']) and $sk_options_weekly_view['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_weekly_view_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_weekly_view_limit"><?php esc_html_e('Events per day', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][weekly_view][limit]" id="mec_skin_weekly_view_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_weekly_view['limit'])) echo esc_attr($sk_options_weekly_view['limit']); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Maximum number of events shown for a single day.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <?php do_action('mec_skin_options_weekly_view_after_limit', $sk_options_weekly_view); ?>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-weekly_view-fluent mec-not-weekly_view-liquid">
                    <label class="mec-check" for="mec_skin_weekly_view_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-weekly_view-fluent mec-not-weekly_view-liquid" id="mec_skin_weekly_view_display_normal_label">
                    <label class="mec-check" for="mec_skin_weekly_view_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check mec-not-weekly_view-fluent mec-not-weekly_view-liquid" id="mec_skin_weekly_view_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_weekly_view_reason_for_cancellation">
                ...
                <!-- End Display Reason for Cancellation -->
                <!-- Start Display Categories -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_weekly_view_display_categories_wp">
                    <label class="mec-check" for="mec_skin_weekly_view_display_categories">
                ...
                <!-- End Display Organizer -->
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_weekly_view_next_previous_button">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_timetable_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_timetable_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][timetable][start_date_type]" id="mec_skin_timetable_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_timetable_start_date_container').show(); else jQuery('#mec_skin_timetable_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_timetable['start_date_type']) or (isset($sk_options_timetable['start_date_type']) and $sk_options_timetable['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_timetable_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_timetable_limit"><?php esc_html_e('Events per day', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][timetable][limit]" id="mec_skin_timetable_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_timetable['limit'])) echo esc_attr($sk_options_timetable['limit']); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Maximum number of events shown for a single day.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-timetable-modern-style-depended">
                    <div class="mec-form-row mec-field">
                        <div class="mec-field__label">
                            <label for="mec_skin_timetable_number_of_days_modern"><?php esc_html_e('Number of Days Per Week', 'modern-events-calendar-lite'); ?></label>
                        </div>
                        <div class="mec-field__control">
                            <select class="wn-mec-select" name="mec[sk-options][timetable][number_of_days_modern]" id="mec_skin_timetable_number_of_days_modern">
                        ...
                        <p class="mec-field__help"><?php esc_html_e('Days shown per week row, e.g. 7 for a full week.', 'modern-events-calendar-lite'); ?></p>
                        </div>
                    </div>
                </div>
                <div class="mec-timetable-clean-style-depended mec-timetable-fluent">
                    <div class="mec-form-row mec-field">
                        <div class="mec-field__label">
                            <label for="mec_skin_timetable_number_of_days"><?php esc_html_e('Number of Days Per Week', 'modern-events-calendar-lite'); ?></label>
                        </div>
                        <div class="mec-field__control">
                            <select class="wn-mec-select" name="mec[sk-options][timetable][number_of_days]" id="mec_skin_timetable_number_of_days">
                    ...
                    <div class="mec-form-row mec-field">
                        <div class="mec-field__label">
                            <label for="mec_skin_timetable_week_start"><?php esc_html_e('Week Start', 'modern-events-calendar-lite'); ?></label>
                        </div>
                        <div class="mec-field__control">
                            <select class="wn-mec-select" name="mec[sk-options][timetable][week_start]" id="mec_skin_timetable_week_start">
                        ...
                        <p class="mec-field__help"><?php esc_html_e('First day of the week.', 'modern-events-calendar-lite'); ?></p>
                        </div>
                    </div>
                </div>
                <div class="mec-timetable-classic-style-depended">
                    <div class="mec-form-row mec-field">
                        ...
                        <div class="mec-field__control">
                            <select class="wn-mec-select" name="mec[sk-options][timetable][start_time]" id="mec_skin_timetable_start_time">
                            ...
                            <select class="wn-mec-select" name="mec[sk-options][timetable][end_time]" id="mec_skin_timetable_end_time">
                ...
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-timetable-fluent mec-not-timetable-liquid">
                    <label class="mec-check" for="mec_skin_timetable_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-timetable-fluent mec-not-timetable-liquid" id="mec_skin_timetable_display_normal_label">
                    <label class="mec-check" for="mec_skin_timetable_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check mec-not-timetable-fluent mec-not-timetable-liquid" id="mec_skin_timetable_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_timetable_reason_for_cancellation">
                ...
                <div class="mec-timetable-modern-style-depended">
                    <div class="mec-form-row mec-field mec-field--check">
                        <label class="mec-check" for="mec_skin_timetable_next_previous_button">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_masonry_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_masonry_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][masonry][start_date_type]" id="mec_skin_masonry_start_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_masonry_start_date_container').show(); else jQuery('#mec_skin_masonry_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_masonry['start_date_type']) or (isset($sk_options_masonry['start_date_type']) and $sk_options_masonry['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_masonry_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_masonry_end_date_type"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][masonry][end_date_type]" id="mec_skin_masonry_end_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_masonry_end_date_container').show(); else jQuery('#mec_skin_masonry_end_date_container').hide();">
                        ...
                        <div class="<?php echo (!isset($sk_options_masonry['end_date_type']) or (isset($sk_options_masonry['end_date_type']) and $sk_options_masonry['end_date_type'] == 'date')) ? '' : 'mec-util-hidden'; ?>" id="mec_skin_masonry_end_date_container">
                ...
                <div class="mec-form-row mec-field mec-skin-masonry-date-format-container">
                    <div class="mec-field__label">
                        <label for="mec_skin_masonry_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][masonry][date_format1]" id="mec_skin_masonry_date_format1" value="<?php echo ((isset($sk_options_masonry['date_format1']) and trim($sk_options_masonry['date_format1']) != '') ? $sk_options_masonry['date_format1'] : 'j'); ?>" />
                        <input type="text" name="mec[sk-options][masonry][date_format2]" id="mec_skin_masonry_date_format2" value="<?php echo ((isset($sk_options_masonry['date_format2']) and trim($sk_options_masonry['date_format2']) != '') ? $sk_options_masonry['date_format2'] : 'F'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_masonry_limit"><?php esc_html_e('Limit', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][masonry][limit]" id="mec_skin_masonry_limit" placeholder="<?php esc_html_e('eg. 24', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_masonry['limit'])) echo esc_attr($sk_options_masonry['limit']); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_masonry_filter_by"><?php esc_html_e('Filter By', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][masonry][filter_by]" id="mec_skin_masonry_filter_by">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Add filter buttons above the grid so visitors can narrow the results.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times">
                    <label class="mec-check" for="mec_skin_masonry_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_masonry_display_normal_label">
                    <label class="mec-check" for="mec_skin_masonry_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_masonry_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_masonry_reason_for_cancellation">
                ...
                <!-- End Display Reason for Cancellation -->
                <!-- Start Display Categories -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_masonry_display_categories_wp">
                    <label class="mec-check" for="mec_skin_masonry_display_categories">
                ...
                <!-- End Display Organizer -->
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_masonry_fit_to_row">
                        ...
                        <span><?php esc_html_e('Fit to row', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Items are arranged into rows. Rows progress vertically. Similar to what you would expect from a layout that uses CSS floats.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_masonry_like_to_grid">
                        ...
                        <span><?php esc_html_e('Convert Masonry to Grid', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Events need a featured image for this style to look right', 'modern-events-calendar-lite'); ?></p>
                </div>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_cover_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_cover_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][cover][style]" id="mec_skin_cover_style" onchange="mec_skin_style_changed('cover', this.value);">
                ...
                <div class="mec-form-row mec-field mec-skin-cover-date-format-container <?php if(isset($sk_options_cover['style']) and $sk_options_cover['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_cover_date_format_clean_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_cover_date_format_clean1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][cover][date_format_clean1]" id="mec_skin_cover_date_format_clean1" value="<?php echo ((isset($sk_options_cover['date_format_clean1']) and trim($sk_options_cover['date_format_clean1']) != '') ? $sk_options_cover['date_format_clean1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][cover][date_format_clean2]" id="mec_skin_cover_date_format_clean2" value="<?php echo ((isset($sk_options_cover['date_format_clean2']) and trim($sk_options_cover['date_format_clean2']) != '') ? $sk_options_cover['date_format_clean2'] : 'M'); ?>" />
                        <input type="text" name="mec[sk-options][cover][date_format_clean3]" id="mec_skin_cover_date_format_clean3" value="<?php echo ((isset($sk_options_cover['date_format_clean3']) and trim($sk_options_cover['date_format_clean3']) != '') ? $sk_options_cover['date_format_clean3'] : 'Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-cover-date-format-container <?php if(isset($sk_options_cover['style']) and $sk_options_cover['style'] != 'classic') echo 'mec-util-hidden'; ?>" id="mec_skin_cover_date_format_classic_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_cover_date_format_classic1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][cover][date_format_classic1]" id="mec_skin_cover_date_format_classic1" value="<?php echo ((isset($sk_options_cover['date_format_classic1']) and trim($sk_options_cover['date_format_classic1']) != '') ? $sk_options_cover['date_format_classic1'] : 'F d'); ?>" />
                        <input type="text" name="mec[sk-options][cover][date_format_classic2]" id="mec_skin_cover_date_format_classic2" value="<?php echo ((isset($sk_options_cover['date_format_classic2']) and trim($sk_options_cover['date_format_classic2']) != '') ? $sk_options_cover['date_format_classic2'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-cover-date-format-container <?php if(isset($sk_options_cover['style']) and $sk_options_cover['style'] != 'liquid-type1') echo 'mec-util-hidden'; ?>" id="mec_skin_cover_date_format_liquid_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_cover_date_format_liquid1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][cover][date_format_liquid1]" id="mec_skin_cover_date_format_liquid1" value="<?php echo ((isset($sk_options_cover['date_format_liquid1']) and trim($sk_options_cover['date_format_liquid1']) != '') ? $sk_options_cover['date_format_liquid1'] : 'F d'); ?>" />
                        <input type="text" name="mec[sk-options][cover][date_format_liquid2]" id="mec_skin_cover_date_format_liquid2" value="<?php echo ((isset($sk_options_cover['date_format_liquid2']) and trim($sk_options_cover['date_format_liquid2']) != '') ? $sk_options_cover['date_format_liquid2'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-cover-date-format-container <?php if(isset($sk_options_cover['style']) and $sk_options_cover['style'] != 'modern') echo 'mec-util-hidden'; ?>" id="mec_skin_cover_date_format_modern_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_cover_date_format_modern1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][cover][date_format_modern1]" id="mec_skin_cover_date_format_modern1" value="<?php echo ((isset($sk_options_cover['date_format_modern1']) and trim($sk_options_cover['date_format_modern1']) != '') ? $sk_options_cover['date_format_modern1'] : 'l, F d Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. l, F d Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_cover_event_id"><?php esc_html_e('Event', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <div class="mec-cover-event-select-wrap">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('The single event this view displays.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-cover-liquid">
                    <label class="mec-check" for="mec_skin_cover_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_cover_display_normal_label">
                    <label class="mec-check" for="mec_skin_cover_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_cover_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_cover_reason_for_cancellation">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_countdown_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_countdown_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][countdown][style]" id="mec_skin_countdown_style" onchange="mec_skin_style_changed('countdown', this.value);">
                ...
                <div class="mec-form-row mec-field mec-skin-countdown-date-format-container <?php if(isset($sk_options_countdown['style']) and $sk_options_countdown['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_countdown_date_format_style1_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_countdown_date_format_style11"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][countdown][date_format_style11]" id="mec_skin_countdown_date_format_style11" value="<?php echo ((isset($sk_options_countdown['date_format_style11']) and trim($sk_options_countdown['date_format_style11']) != '') ? $sk_options_countdown['date_format_style11'] : 'j F Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. j F Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-countdown-date-format-container <?php if(isset($sk_options_countdown['style']) and $sk_options_countdown['style'] != 'style2') echo 'mec-util-hidden'; ?>" id="mec_skin_countdown_date_format_style2_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_countdown_date_format_style21"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][countdown][date_format_style21]" id="mec_skin_countdown_date_format_style21" value="<?php echo ((isset($sk_options_countdown['date_format_style21']) and trim($sk_options_countdown['date_format_style21']) != '') ? $sk_options_countdown['date_format_style21'] : 'j F Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. j F Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-countdown-date-format-container <?php if(isset($sk_options_countdown['style']) and $sk_options_countdown['style'] != 'style3') echo 'mec-util-hidden'; ?>" id="mec_skin_countdown_date_format_style3_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_countdown_date_format_style31"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][countdown][date_format_style31]" id="mec_skin_countdown_date_format_style31" value="<?php echo ((isset($sk_options_countdown['date_format_style31']) and trim($sk_options_countdown['date_format_style31']) != '') ? $sk_options_countdown['date_format_style31'] : 'j'); ?>" />
                        <input type="text" name="mec[sk-options][countdown][date_format_style32]" id="mec_skin_countdown_date_format_style32" value="<?php echo ((isset($sk_options_countdown['date_format_style32']) and trim($sk_options_countdown['date_format_style32']) != '') ? $sk_options_countdown['date_format_style32'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][countdown][date_format_style33]" id="mec_skin_countdown_date_format_style33" value="<?php echo ((isset($sk_options_countdown['date_format_style33']) and trim($sk_options_countdown['date_format_style33']) != '') ? $sk_options_countdown['date_format_style33'] : 'Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_countdown_event_id"><?php esc_html_e('Event', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][countdown][event_id]" id="mec_skin_countdown_event_id" onchange="mec_toggle_countdown_category(this.value);">
                ...
                <div class="mec-form-row mec-field <?php if(isset($sk_options_countdown['event_id']) and $sk_options_countdown['event_id'] != '-1') echo 'mec-util-hidden'; ?>" id="mec_skin_countdown_category_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_countdown_category"><?php esc_html_e('Category', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Restrict the automatic Next Upcoming Event to these categories.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-not-countdown-fluent mec-not-countdown-liquid">
                    <div class="mec-field__label">
                        <label for="mec_skin_countdown_bg_color"><?php esc_html_e('Background Color', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" class="mec-color-picker wp-color-picker-field" id="mec_skin_countdown_bg_color" name="mec[sk-options][countdown][bg_color]" value="<?php echo ((isset($sk_options_countdown['bg_color']) and trim($sk_options_countdown['bg_color']) != '') ? $sk_options_countdown['bg_color'] : '#437df9'); ?>" data-default-color="#437df9" />
                    <p class="mec-field__help"><?php esc_html_e('Background color of this block. Leave empty for the default.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times">
                    <label class="mec-check" for="mec_skin_countdown_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_countdown_display_normal_label">
                    <label class="mec-check" for="mec_skin_countdown_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_countdown_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_countdown_reason_for_cancellation">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_available_spot_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_available_spot_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][available_spot][style]" id="mec_skin_available_spot_style" onchange="mec_skin_style_changed('available_spot', this.value);">
                ...
                <div class="mec-form-row mec-field mec-skin-available-spot-date-format-container mec-not-available_spot-fluent mec-not-available_spot-liquid">
                    <div class="mec-field__label">
                        <label for="mec_skin_available_spot_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][available_spot][date_format1]" id="mec_skin_available_spot_date_format1" value="<?php echo ((isset($sk_options_available_spot['date_format1']) and trim($sk_options_available_spot['date_format1']) != '') ? $sk_options_available_spot['date_format1'] : 'j'); ?>" />
                        <input type="text" name="mec[sk-options][available_spot][date_format2]" id="mec_skin_available_spot_date_format2" value="<?php echo ((isset($sk_options_available_spot['date_format2']) and trim($sk_options_available_spot['date_format2']) != '') ? $sk_options_available_spot['date_format2'] : 'F'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_available_spot_event_id"><?php esc_html_e('Event', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][available_spot][event_id]" id="mec_skin_available_spot_event_id">
                ...
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-available_spot-liquid">
                    <label class="mec-check" for="mec_skin_available_spot_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_available_spot_display_normal_label">
                    <label class="mec-check" for="mec_skin_available_spot_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_available_spot_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_available_spot_reason_for_cancellation">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_carousel_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][carousel][start_date_type]" id="mec_skin_carousel_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_carousel_start_date_container').show(); else jQuery('#mec_skin_carousel_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_carousel['start_date_type']) or (isset($sk_options_carousel['start_date_type']) and $sk_options_carousel['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_carousel_start_date_container">
                ...
                <div class="mec-form-row mec-field mec-skin-carousel-date-format-container <?php if(isset($sk_options_carousel['style']) and $sk_options_carousel['style'] != 'type1') echo 'mec-util-hidden'; ?>" id="mec_skin_carousel_date_format_type1_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_type1_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][carousel][type1_date_format1]" id="mec_skin_carousel_type1_date_format1" value="<?php echo ((isset($sk_options_carousel['type1_date_format1']) and trim($sk_options_carousel['type1_date_format1']) != '') ? $sk_options_carousel['type1_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][carousel][type1_date_format2]" id="mec_skin_carousel_type1_date_format2" value="<?php echo ((isset($sk_options_carousel['type1_date_format2']) and trim($sk_options_carousel['type1_date_format2']) != '') ? $sk_options_carousel['type1_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][carousel][type1_date_format3]" id="mec_skin_carousel_type1_date_format3" value="<?php echo ((isset($sk_options_carousel['type1_date_format3']) and trim($sk_options_carousel['type1_date_format3']) != '') ? $sk_options_carousel['type1_date_format3'] : 'Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-carousel-date-format-container <?php if(isset($sk_options_carousel['style']) and $sk_options_carousel['style'] != 'type2') echo 'mec-util-hidden'; ?>" id="mec_skin_carousel_date_format_type2_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_type2_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][carousel][type2_date_format1]" id="mec_skin_carousel_type2_date_format1" value="<?php echo ((isset($sk_options_carousel['type2_date_format1']) and trim($sk_options_carousel['type2_date_format1']) != '') ? $sk_options_carousel['type2_date_format1'] : 'M d, Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. M d, Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-carousel-date-format-container <?php if(isset($sk_options_carousel['style']) and $sk_options_carousel['style'] != 'type3') echo 'mec-util-hidden'; ?>" id="mec_skin_carousel_date_format_type3_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_type3_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][carousel][type3_date_format1]" id="mec_skin_carousel_type3_date_format1" value="<?php echo ((isset($sk_options_carousel['type3_date_format1']) and trim($sk_options_carousel['type3_date_format1']) != '') ? $sk_options_carousel['type3_date_format1'] : 'M d, Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. M d, Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-carousel-date-format-container <?php if(isset($sk_options_carousel['style']) and strpos($sk_options_carousel['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_carousel_date_format_liquid_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_liquid_date_format1"><?php esc_html_e('Date Format', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][carousel][liquid_date_format1]" id="mec_skin_carousel_liquid_date_format1" value="<?php echo ((isset($sk_options_carousel['liquid_date_format1']) and trim($sk_options_carousel['liquid_date_format1']) != '') ? $sk_options_carousel['liquid_date_format1'] : 'd F Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. d F Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_count"><?php esc_html_e('Count in row', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][carousel][count]" id="mec_skin_carousel_count">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_count_tablet"><?php esc_html_e('Count in row (Tablet)', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][carousel][count_tablet]" id="mec_skin_carousel_count_tablet">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Number of event cards per row on tablet screens.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_count_mobile"><?php esc_html_e('Count in row (Mobile)', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][carousel][count_mobile]" id="mec_skin_carousel_count_mobile">
                    ...
                    <p class="mec-field__help"><?php esc_html_e('Number of event cards per row on mobile screens.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_limit"><?php esc_html_e('Limit', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][carousel][limit]" id="mec_skin_carousel_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_carousel['limit'])) echo esc_attr($sk_options_carousel['limit']); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_carousel_autoplay_status">
                        ...
                        <span><?php esc_html_e('Auto Play', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Scroll the carousel automatically.', 'modern-events-calendar-lite'); ?></p>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_autoplay"><?php esc_html_e('Auto Play Time', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" min="1000" step="1" name="mec[sk-options][carousel][autoplay]" id="mec_skin_carousel_autoplay" placeholder="<?php esc_html_e('eg. 3000 default is 3 second', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_carousel['autoplay']) && $sk_options_carousel['autoplay'] != '') echo esc_attr($sk_options_carousel['autoplay']); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Seconds between automatic slides. Set 0 to disable autoplay.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_carousel_loop_status">
                        ...
                        <span><?php esc_html_e('Loop', 'modern-events-calendar-lite'); ?></span>
                    </label>
                    <p class="mec-field__help"><?php esc_html_e('Restart from the first slide after the last one.', 'modern-events-calendar-lite'); ?></p>
                </div>
                ...
                <div class="mec-form-row mec-field mec-carousel-archive-link">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_archive_link"><?php esc_html_e('Archive Link', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][carousel][archive_link]" id="mec_skin_carousel_archive_link" value="<?php echo ((isset($sk_options_carousel['archive_link']) and trim($sk_options_carousel['archive_link']) != '') ? $sk_options_carousel['archive_link'] : ''); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('URL of the page the archive button points to.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-carousel-head-text">
                    <div class="mec-field__label">
                        <label for="mec_skin_carousel_head_text"><?php esc_html_e('Head Text', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][carousel][head_text]" id="mec_skin_carousel_head_text" value="<?php echo ((isset($sk_options_carousel['head_text']) and trim($sk_options_carousel['head_text']) != '') ? $sk_options_carousel['head_text'] : ''); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Heading shown above the carousel.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-carousel-liquid">
                    <label class="mec-check" for="mec_skin_carousel_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Include Events Times -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-times mec-not-carousel-liquid">
                    <label class="mec-check" for="mec_skin_carousel_include_events_times">
                ...
                <!-- End Include Events Times -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_carousel_display_normal_label">
                    <label class="mec-check" for="mec_skin_carousel_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_carousel_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_carousel_reason_for_cancellation">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_slider_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_style"><?php esc_html_e('Style', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][slider][style]" id="mec_skin_slider_style" onchange="mec_skin_style_changed('slider', this.value);">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][slider][start_date_type]" id="mec_skin_slider_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_slider_start_date_container').show(); else jQuery('#mec_skin_slider_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_slider['start_date_type']) or (isset($sk_options_slider['start_date_type']) and $sk_options_slider['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_slider_start_date_container">
                ...
                <div class="mec-form-row mec-field mec-skin-slider-date-format-container <?php if(isset($sk_options_slider['style']) and $sk_options_slider['style'] != 't1') echo 'mec-util-hidden'; ?>" id="mec_skin_slider_date_format_t1_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_type1_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][slider][type1_date_format1]" id="mec_skin_slider_type1_date_format1" value="<?php echo ((isset($sk_options_slider['type1_date_format1']) and trim($sk_options_slider['type1_date_format1']) != '') ? $sk_options_slider['type1_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type1_date_format2]" id="mec_skin_slider_type1_date_format2" value="<?php echo ((isset($sk_options_slider['type1_date_format2']) and trim($sk_options_slider['type1_date_format2']) != '') ? $sk_options_slider['type1_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type1_date_format3]" id="mec_skin_slider_type1_date_format3" value="<?php echo ((isset($sk_options_slider['type1_date_format3']) and trim($sk_options_slider['type1_date_format3']) != '') ? $sk_options_slider['type1_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-slider-date-format-container <?php if(isset($sk_options_slider['style']) and $sk_options_slider['style'] != 't2') echo 'mec-util-hidden'; ?>" id="mec_skin_slider_date_format_t2_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_type2_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][slider][type2_date_format1]" id="mec_skin_slider_type2_date_format1" value="<?php echo ((isset($sk_options_slider['type2_date_format1']) and trim($sk_options_slider['type2_date_format1']) != '') ? $sk_options_slider['type2_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type2_date_format2]" id="mec_skin_slider_type2_date_format2" value="<?php echo ((isset($sk_options_slider['type2_date_format2']) and trim($sk_options_slider['type2_date_format2']) != '') ? $sk_options_slider['type2_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type2_date_format3]" id="mec_skin_slider_type2_date_format3" value="<?php echo ((isset($sk_options_slider['type2_date_format3']) and trim($sk_options_slider['type2_date_format3']) != '') ? $sk_options_slider['type2_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-slider-date-format-container <?php if(isset($sk_options_slider['style']) and $sk_options_slider['style'] != 't3') echo 'mec-util-hidden'; ?>" id="mec_skin_slider_date_format_t3_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_type3_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][slider][type3_date_format1]" id="mec_skin_slider_type3_date_format1" value="<?php echo ((isset($sk_options_slider['type3_date_format1']) and trim($sk_options_slider['type3_date_format1']) != '') ? $sk_options_slider['type3_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type3_date_format2]" id="mec_skin_slider_type3_date_format2" value="<?php echo ((isset($sk_options_slider['type3_date_format2']) and trim($sk_options_slider['type3_date_format2']) != '') ? $sk_options_slider['type3_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type3_date_format3]" id="mec_skin_slider_type3_date_format3" value="<?php echo ((isset($sk_options_slider['type3_date_format3']) and trim($sk_options_slider['type3_date_format3']) != '') ? $sk_options_slider['type3_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-slider-date-format-container <?php if(isset($sk_options_slider['style']) and $sk_options_slider['style'] != 't4') echo 'mec-util-hidden'; ?>" id="mec_skin_slider_date_format_t4_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_type4_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][slider][type4_date_format1]" id="mec_skin_slider_type4_date_format1" value="<?php echo ((isset($sk_options_slider['type4_date_format1']) and trim($sk_options_slider['type4_date_format1']) != '') ? $sk_options_slider['type4_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type4_date_format2]" id="mec_skin_slider_type4_date_format2" value="<?php echo ((isset($sk_options_slider['type4_date_format2']) and trim($sk_options_slider['type4_date_format2']) != '') ? $sk_options_slider['type4_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type4_date_format3]" id="mec_skin_slider_type4_date_format3" value="<?php echo ((isset($sk_options_slider['type4_date_format3']) and trim($sk_options_slider['type4_date_format3']) != '') ? $sk_options_slider['type4_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-slider-date-format-container <?php if(isset($sk_options_slider['style']) and $sk_options_slider['style'] != 't5') echo 'mec-util-hidden'; ?>" id="mec_skin_slider_date_format_t5_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_type5_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][slider][type5_date_format1]" id="mec_skin_slider_type5_date_format1" value="<?php echo ((isset($sk_options_slider['type5_date_format1']) and trim($sk_options_slider['type5_date_format1']) != '') ? $sk_options_slider['type5_date_format1'] : 'd'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type5_date_format2]" id="mec_skin_slider_type5_date_format2" value="<?php echo ((isset($sk_options_slider['type5_date_format2']) and trim($sk_options_slider['type5_date_format2']) != '') ? $sk_options_slider['type5_date_format2'] : 'F'); ?>" />
                        <input type="text" name="mec[sk-options][slider][type5_date_format3]" id="mec_skin_slider_type5_date_format3" value="<?php echo ((isset($sk_options_slider['type5_date_format3']) and trim($sk_options_slider['type5_date_format3']) != '') ? $sk_options_slider['type5_date_format3'] : 'l'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-skin-slider-date-format-container <?php if(isset($sk_options_slider['style']) and strpos($sk_options_slider['style'], 'liquid') === false) echo 'mec-util-hidden'; ?>" id="mec_skin_slider_date_format_liquid_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_liquid_date_format1"><?php esc_html_e('Date Format', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][slider][liquid_date_format1]" id="mec_skin_slider_liquid_date_format1" value="<?php echo ((isset($sk_options_slider['liquid_date_format1']) and trim($sk_options_slider['liquid_date_format1']) != '') ? $sk_options_slider['liquid_date_format1'] : 'd F Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. d F Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_limit"><?php esc_html_e('Limit', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][slider][limit]" id="mec_skin_slider_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_slider['limit'])) echo esc_attr($sk_options_slider['limit']); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_autoplay"><?php esc_html_e('Auto Play Time', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" min="1000" step="1" name="mec[sk-options][slider][autoplay]" id="mec_skin_slider_autoplay" placeholder="<?php esc_html_e('eg. 3000 default is 3 second', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_slider['autoplay']) && $sk_options_slider['autoplay'] != '') echo esc_attr($sk_options_slider['autoplay']); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Seconds between automatic slides. Set 0 to disable autoplay.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_slider_transition_time"><?php esc_html_e('Transition Time', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" min="0" step="1" name="mec[sk-options][slider][transition_time]" id="mec_skin_slider_transition_time" placeholder="<?php esc_html_e('eg. 1000 is 1 second', 'modern-events-calendar-lite'); ?>" value="<?php echo ((isset($sk_options_slider['transition_time']) && $sk_options_slider['transition_time'] != '') ? $sk_options_slider['transition_time'] : 250); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Slide change animation duration in milliseconds.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-slider-liquid">
                    <label class="mec-check" for="mec_skin_slider_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_slider_display_normal_label">
                    <label class="mec-check" for="mec_skin_slider_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_slider_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_slider_reason_for_cancellation">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_timeline_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_timeline_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][timeline][start_date_type]" id="mec_skin_timeline_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_timeline_start_date_container').show(); else jQuery('#mec_skin_timeline_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_timeline['start_date_type']) or (isset($sk_options_timeline['start_date_type']) and $sk_options_timeline['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_timeline_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_timeline_end_date_type"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][timeline][end_date_type]" id="mec_skin_timeline_end_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_timeline_end_date_container').show(); else jQuery('#mec_skin_timeline_end_date_container').hide();">
                        ...
                        <div class="<?php echo (!isset($sk_options_timeline['end_date_type']) or (isset($sk_options_timeline['end_date_type']) and $sk_options_timeline['end_date_type'] == 'date')) ? '' : 'mec-util-hidden'; ?>" id="mec_skin_timeline_end_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_timeline_classic_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][timeline][classic_date_format1]" id="mec_skin_timeline_classic_date_format1" value="<?php echo ((isset($sk_options_timeline['classic_date_format1']) and trim($sk_options_timeline['classic_date_format1']) != '') ? $sk_options_timeline['classic_date_format1'] : 'd F Y'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens, e.g. d F Y. A live example shows below the field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_timeline_limit"><?php esc_html_e('Limit', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="number" name="mec[sk-options][timeline][limit]" id="mec_skin_timeline_limit" placeholder="<?php esc_html_e('eg. 6', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_timeline['limit'])) echo esc_attr($sk_options_timeline['limit']); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times">
                    <label class="mec-check" for="mec_skin_timeline_include_local_time">
                ...
                <!-- End LocalTime -->
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_timeline_display_normal_label">
                    <label class="mec-check" for="mec_skin_timeline_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_timeline_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_timeline_reason_for_cancellation">
                ...
                <!-- End Display Reason for Cancellation -->
                <!-- Start Display Categories -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_timeline_display_categories_wp">
                    <label class="mec-check" for="mec_skin_timeline_display_categories">
                ...
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_timeline_month_divider">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_tile_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_tile_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][tile][start_date_type]" id="mec_skin_tile_start_date_type" onchange="if(this.value == 'date') jQuery('#mec_skin_tile_start_date_container').show(); else jQuery('#mec_skin_tile_start_date_container').hide();">
                        <option value="today" <?php if(isset($sk_options_tile['start_date_type']) and $sk_options_tile['start_date_type'] == 'today') echo 'selected="selected"'; ?>><?php esc_html_e('Today', 'modern-events-calendar-lite'); ?></option>
                        <option value="tomorrow" <?php if(isset($sk_options_tile['start_date_type']) and $sk_options_tile['start_date_type'] == 'tomorrow') echo 'selected="selected"'; ?>><?php esc_html_e('Tomorrow', 'modern-events-calendar-lite'); ?></option>
                        <option value="yesterday" <?php if(isset($sk_options_tile['start_date_type']) and $sk_options_tile['start_date_type'] == 'yesterday') echo 'selected="selected"'; ?>><?php esc_html_e('Yesterday', 'modern-events-calendar-lite'); ?></option>
                        ...
                        <div class="<?php if(!isset($sk_options_tile['start_date_type']) || $sk_options_tile['start_date_type'] != 'date') echo 'mec-util-hidden'; ?>" id="mec_skin_tile_start_date_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_tile_end_date_type"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][tile][end_date_type]" id="mec_skin_tile_end_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_tile_end_date_container').show(); else jQuery('#mec_skin_tile_end_date_container').hide();">
                        ...
                        <div class="<?php echo (!isset($sk_options_tile['end_date_type']) or (isset($sk_options_tile['end_date_type']) and $sk_options_tile['end_date_type'] == 'date')) ? '' : 'mec-util-hidden'; ?>" id="mec_skin_tile_end_date_container">
                ...
                <div class="mec-form-row mec-field mec-skin-tile-date-format-container <?php if(isset($sk_options_tile['style']) and $sk_options_tile['style'] != 'clean') echo 'mec-util-hidden'; ?>" id="mec_skin_tile_date_format_clean_container">
                    <div class="mec-field__label">
                        <label for="mec_skin_tile_minimal_date_format1"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][tile][clean_date_format1]" id="mec_skin_tile_clean_date_format1" value="<?php echo ((isset($sk_options_tile['clean_date_format1']) and trim($sk_options_tile['clean_date_format1']) != '') ? $sk_options_tile['clean_date_format1'] : 'j'); ?>" />
                        <input type="text" name="mec[sk-options][tile][clean_date_format2]" id="mec_skin_tile_clean_date_format2" value="<?php echo ((isset($sk_options_tile['clean_date_format2']) and trim($sk_options_tile['clean_date_format2']) != '') ? $sk_options_tile['clean_date_format2'] : 'M'); ?>" />
                        <p class="mec-field__help"><?php esc_html_e('PHP date tokens for the date blocks. Live examples show below each field.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_tile_count"><?php esc_html_e('Count in row', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][tile][count]" id="mec_skin_tile_count">
                ...
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times" id="mec_skin_tile_display_normal_label">
                    <label class="mec-check" for="mec_skin_tile_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_tile_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_tile_reason_for_cancellation">
                ...
                <!-- End Display Reason for Cancellation -->
                <!-- Start Display Categories -->
                <div class="mec-form-row mec-field mec-field--check" id="mec_skin_tile_display_categories_wp">
                    <label class="mec-check" for="mec_skin_tile_display_categories">
                ...
                <!-- End Display Organizer -->
                <div class="mec-form-row mec-field mec-field--check">
                    <label class="mec-check" for="mec_skin_tile_next_previous_button">
                ...
                <div id="mec_tile_off_month_options" <?php if(!isset($sk_options_tile['next_previous_button']) or (isset($sk_options_tile['next_previous_button']) and $sk_options_tile['next_previous_button'])) echo 'style="display:none;"'; ?>>
                    <div class="mec-form-row mec-field">
                        <div class="mec-field__label">
                            <label for="mec_skin_tile_limit"><?php esc_html_e('Limit', 'modern-events-calendar-lite'); ?></label>
                        </div>
                        <div class="mec-field__control">
                            <input type="number" name="mec[sk-options][tile][limit]" id="mec_skin_tile_limit" placeholder="<?php esc_html_e('eg. 60', 'modern-events-calendar-lite'); ?>" value="<?php if(isset($sk_options_tile['limit'])) echo esc_attr($sk_options_tile['limit']); ?>" />
                            <p class="mec-field__help"><?php esc_html_e('Maximum number of events to show in this view.', 'modern-events-calendar-lite'); ?></p>
                        </div>
                    </div>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_general_calendar_skin_options_container">
                ...
                <div class="mec-form-row mec-field">
                    <div class="mec-field__label">
                        <label for="mec_skin_general_calendar_start_date_type"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <select class="wn-mec-select" name="mec[sk-options][general_calendar][start_date_type]" id="mec_skin_general_calendar_start_date_type" onchange="if(this.value === 'date') jQuery('#mec_skin_general_calendar_start_date_container').show(); else jQuery('#mec_skin_general_calendar_start_date_container').hide();">
                        ...
                        <div class="<?php if(!isset($sk_options_general_calendar['start_date_type']) or (isset($sk_options_general_calendar['start_date_type']) and $sk_options_general_calendar['start_date_type'] != 'date')) echo 'mec-util-hidden'; ?>" id="mec_skin_general_calendar_start_date_container">
                ...
                <div class="mec-form-row mec-field mec-not-general_calendar-liquid">
                    <div class="mec-field__label">
                        <label for="mec_skin_general_calendar_more_event"><?php esc_html_e('Number of events in a cell to view "more"', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-field__control">
                        <input type="text" name="mec[sk-options][general_calendar][more_event]" id="mec_skin_general_calendar_more_event" value="<?php echo ((isset($sk_options_general_calendar['more_event']) and trim($sk_options_general_calendar['more_event']) != '') ? $sk_options_general_calendar['more_event'] : ''); ?>" />
                    <p class="mec-field__help"><?php esc_html_e('Events per day cell before the more link appears.', 'modern-events-calendar-lite'); ?></p>
                    </div>
                </div>
                <div class="mec-form-row mec-field mec-field--check mec-include-events-local-times mec-not-general_calendar-fluent mec-not-general_calendar-liquid">
                    <label class="mec-check" for="mec_skin_general_calendar_include_local_time">
                ...
                <!-- Start Display Label -->
                <div class="mec-form-row mec-field mec-field--check mec-not-general_calendar-liquid" id="mec_skin_general_calendar_display_normal_label">
                    <label class="mec-check" for="mec_skin_general_calendar_display_label">
                ...
                <!-- End Display Label -->
                <!-- Start Reason for Cancellation -->
                <div class="mec-form-row mec-field mec-field--check mec-not-general_calendar-liquid" id="mec_skin_general_calendar_display_reason_for_cancellation">
                    <label class="mec-check" for="mec_skin_general_calendar_reason_for_cancellation">
