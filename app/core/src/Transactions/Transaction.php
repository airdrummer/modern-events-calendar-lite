...
class Transaction
{
    ...
    public function prepare_data($data)
    {
        ...
        return wp_parse_args(
            ...
            [
                ...
                'partial_payment_settings' => $is_partial_payment ? $this->bookClass->partial_payment->get_validated_payable_options($event_id) : [],
            ]
        );
    }
    ...
    private function get_saved_data()
    {
        ...
        $data = get_option($this->transaction_id, []);
    ...
    public function get_dates()
    {
        ...
        $all_dates = isset($this->data['all_dates']) && is_array($this->data['all_dates']) && !empty($this->data['all_dates']) ? $this->data['all_dates'] : [$this->data['date'] ?? ''];
        ...
        if ($order)
        {
            ...
            foreach ($coupons as $coupon_code)
            {
                ...
                if (!isset($discounts_details["wc_coupon_{$coupon_code}"]))
                {
                    ...
                    $discounts_details["wc_coupon_{$coupon_code}"] = [
        ...
        if ($user_id)
        {
            ...
            if (trim($role_discount) and is_numeric($role_discount))
            {
                ...
                if (!isset($discounts_details['roles_discount']))
                {
                    ...
                    $discounts_details['roles_discount'] = [
        ...
        if ($coupon)
        {
            ...
            if ($coupon_id)
            {
                ...
                if (!isset($discounts_details['coupon_discount']))
                {
                    ...
                    $discounts_details['coupon_discount'] = [
    ...
    private function get_all_occurrences_details()
    {
        ...
        $this->price_details = $this->get_details([
            // 'attendee_key' => 0,
        ]);
    ...
    public function get_tickets_details($filters = [])
    {
    ...
    public function get_variations_details($filters = [])
    {
    ...
    public function get_variations($filters = [])
    {
    ...
    public function calculate_partial_payment($filters = [], $apply_fees = true)
    {
    ...
    public function get_fees_details($filters = [])
    {
    ...
    public function get_emails($filters = [])
    {
    ...
    public function get_tickets_dates($filters = [])
    {
    ...
    public function get_fees($filters = [])
    {
    ...
    public function get_discounts($filters = [])
    {
    ...
    public function get_subtotal($filters = [], $apply_fees = true)
    {
    ...
    public function get_total($filters = [], $apply_fees = true)
    {
    ...
    public function get_payable($filters = [], $apply_fees = true)
    {
    ...
    public function get_total_dates($filters = [])
    {
    ...
    public function get_attendees_info($filters = [])
    {
    ...
    public function register_user($attendee, $args = [])
    {
    ...
    public function create_book_from_transaction($args = [], $rebuild = false)
    {
    ...
    public function create_fee_product($fee_detail, $related_products = [], $update = false)
    {
    ...
    public static function upgrade_db()
    {
        ...
        add_filter('mec_transaction_get_event_fees', [__CLASS__, 'filter_transaction_get_event_fees'], 10, 3);
        ...
        foreach ($transaction_ids as $book_id => $transaction_id)
        {
            ...
            if (!isset($transaction['applied_fee']))
            {
                ...
                $has_fee = in_array(
                    'fee',
                    array_column($transaction['price_details']['details'] ?? [], 'type')
                );
