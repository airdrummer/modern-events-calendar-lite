...
= v 7.35.0 - 1 August 2026 =
- Added: Opt-in product usage tracking with consent.
- Added: The ability to set a custom center point for the map skin.
- Added: Setup Wizard menu access for editor users.
- Fixed: The date display in timetable skin.
- Fixed: TEC to MEC migration process.
- Fixed: The install and update queries.
- Fixed: The booking CSV and Excel export to respect the backend filters.
- Fixed: The CSV booking import to support custom column headers and seat counts.
- Fixed: The HTML sanitizer to preserve inline script and style tags.
- Fixed: Some issues in General Calendar skin.
- Fixed: An issue in custom repeat events.
- Fixed: Some issues in notifications templates per event.
- Fixed: Some issues in paragraph tag of booking fields.
- Fixed: Some security issues reported by PatchStack and others.
- Fixed: An HTML formatting issue in Frontend Event Submission.
- Fixed: An issue in user registration after booking.
- Fixed: A filter issue in booking management menu in backend.
- Fixed: An issue in RESTful API.
- Fixed: An image issue in tile skin.
- Fixed: Some issues in rendering notification placeholders.
- Fixed: Some issues in Event Banner module.
- Fixed: Some issues in running MEC cron tasks.
- Fixed: An issue in Pay Locally gateway.
- Fixed: An issue with the Full Calendar skin on archive pages.
- Fixed: An issue in map events rendering of the Custom skin.
- Fixed: An issue in detecting the WordPress root path in PayPal IPN handlers.
- Fixed: Some minor styling issues in frontend and backend.

= v 7.34.2 - 25 June 2026 =
- Fixed: An issue with HTML content in notification settings not being properly preserved.

= v 7.34.1 - 22 June 2026 =
- Fixed: A styling issue in the classic calendar view within booking calendar.
- Fixed: An issue in Novel style of the monthly view skin.

= v 7.34.0 - 21 June 2026 =
- Added: A new feature in shortcodes to display only events, only appointments, or both at the same time.
- Added: An interface to manage event colors.
- Added: More details to PayPal transactions.
- Added: An option to control visibility of ticket fields (minimum ticket, maximum ticket, stop selling) in Frontend Event Submission.
- Enhanced: MEC security by hardening some sections.
- Improved: The search module functionality.
- Enhanced: Accessibility of frontend calendars.
- Improved: MEC Restful API by adding new endpoints for category, label, speaker, tag, and sponsor management.
- Improved: Accessibility of social share module.
- Enhanced: The search functionality to include multiple day events in applicable months.
- Improved: WooCommerce integration.
- Improved: The ticket section UX in Frontend Event Submission with labels and tooltips.
- Improved: The Booking Express Calendar with a new design.
- Fixed: A date format issue in map module.
- Fixed: An issue in XML import of events.
- Fixed: A localization issue in General calendar.
- Fixed: An issue in bulk actions of MEC backend in large scale websites.
- Fixed: An issue in displaying true seats in exports.
- Fixed: Some PHP issues.
- Fixed: A date format issue in Masonry skin.
- Fixed: An issue in Stripe connect gateway.
- Fixed: An issue in displaying booking data in PDF invoices.
- Fixed: Some issues in invalid single event pages.
- Fixed: Centered the wizard popup on all screen sizes.
...
- Improved: The Restful API by adding information of event labels.
- Improved: The MEC tags system.
- Added: End date and descending order to the tile skin.
- Fixed: Couple of issues in search bar.
- Resolved: An issue in making event description field required in the Frontend submission.
- Fixed: Some PHP issues.
- Fixed: An issue in ticket variations and tax / fees system regarding special characters.
- Fixed: Some issues in Exceptional Days module.
